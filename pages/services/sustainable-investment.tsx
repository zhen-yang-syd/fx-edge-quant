      ...
      <main className='w-full relative'>
        ...
        <div className='w-full bg-white'>
          <div className='paragraph-container text-black drop-shadow-lg'>
            ...
            <div className={`flex flex-col gap-4 text-gray-500 capitalize px-4 ${paragrahStyle}`}>
        ...
        <div className='w-full bg-gray-300'>
          <div className='paragraph-container text-black drop-shadow-lg'>
            ...
            <p className={`text-gray-500 text-center px-4 text-base`}>ESG refers to specific considerations that can be used as part of investment decision-making:</p>
