						...
						<div className='w-[70%] mx-auto z-50'>
							<Collapse defaultActiveKey={['1']} ghost accordion className='text-white w-full z-50'>
								...
								<Panel header="Sustainable" key="2">
									<Divider className='bg-white m-0 mb-5' />
									<p className={`leading-[30px] text-white ${paragrahStyle}`}>EDGE’s approach to sustainable investing is rooted in our fiduciary duty to clients. We start by understanding our clients’ investment objectives and provide choice to meet their needs; we seek the best risk-adjusted returns within the scope of mandates they give us; and we underpin our work with research, data, and analytics.</p>
								</Panel>
								<Panel header="Consistent" key="3">
									<Divider className='bg-white m-0 mb-5' />
									<p className={`leading-[30px] text-white ${paragrahStyle}`}>As an independent, fiduciary asset manager, EDGE is committed to acting at all times in the best long-term interests of our fund investors.</p>
								</Panel>
								<Panel header="Diverse" key="4">
									<Divider className='bg-white m-0 mb-5' />
									<p className={`leading-[30px] text-white ${paragrahStyle}`}>EDGE offers a diverse range of financial products, including Equities, ETFs, Derivatives, CFDs, and International Trading.</p>
								</Panel>
							</Collapse>
						</div>
					</div>
				...
				<Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} centered width={1000} closable={false} footer={null}>
					<div className='w-full'>
						...
						<div className='w-full h-[300px] overflow-scroll flex flex-col gap-2'>
							...
							<p className='text-base text-gray-400 drop-shadow-lg text-justify'>This website provides general information, details Offers available via Edge Ark Pty Ltd and allows Members to participate in these Offers. We do not provide investment advice, and information on our website does not take into account your personal and financial circumstances, needs and objectives. Because of that, you should consider the appropriateness of the information with regards to your personal circumstances, needs and objectives before making an investment decision.</p>
							...
							<p className='text-base text-gray-400 drop-shadow-lg text-justify'>Information contained in the material is based on data from multiple sources and Edge Ark Pty Ltd makes no representation as to the accuracy or completeness of data from sources outside of Edge Ark Pty Ltd. References to third parties contained herein should not be considered a solicitation on behalf of or an endorsement of those entities by Edge Ark Pty Ltd. The opinions expressed by the author of an article written by a third party are solely his/her own and do not necessarily reflect those of Edge Ark Pty Ltd. The information and data provided by any third-party web site or publication are as of the date of the article when it was written and is subject to change without notice.</p>
						</div>
