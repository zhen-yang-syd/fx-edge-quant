				...
				<Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} centered width={1000} closable={false} footer={null}>
					<div className='w-full'>
						...
						<div className='w-full h-[300px] overflow-scroll flex flex-col gap-2'>
							...
							<p className='text-base text-gray-400 drop-shadow-lg text-justify'>This website provides general information, details Offers available via Midas Markets Investment Manager Ltd  and allows Members to participate in these Offers. We do not provide investment advice, and information on our website does not take into account your personal and financial circumstances, needs and objectives. Because of that, you should consider the appropriateness of the information with regards to your personal circumstances, needs and objectives before making an investment decision.</p>
							...
							<p className='text-base text-gray-400 drop-shadow-lg text-justify'>Information contained in the material is based on data from multiple sources and Midas Markets Investment Manager Ltd  makes no representation as to the accuracy or completeness of data from sources outside of Midas Markets Investment Manager Ltd . References to third parties contained herein should not be considered a solicitation on behalf of or an endorsement of those entities by Midas Markets Investment Manager Ltd . The opinions expressed by the author of an article written by a third party are solely his/her own and do not necessarily reflect those of Midas Markets Investment Manager Ltd . The information and data provided by any third-party web site or publication are as of the date of the article when it was written and is subject to change without notice.</p>
						</div>
